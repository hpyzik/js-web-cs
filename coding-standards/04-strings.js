(function () {
    ...
    var rules = {
        ...
        'Strings that cause the line to go over 120 characters..': function () {
            /*
             Strings that cause the line to go over 120 characters should be written across multiple lines
             using string concatenation - plus operator at the beginning of line.
             */
